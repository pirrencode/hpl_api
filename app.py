...
from simulation_scenarios import generate_cr_env_using_input_data
import openai
import time
import requests
import json
    ...
    try:
        ...
        insert_query = f"""
            ...
            VALUES ({id}, '{model}', '{content_type}', '{start_date}', '{end_date}', {genai_response_time}, 
                    ...
                    {prompt_volume}, {output_volume}, '{correctness}', 
