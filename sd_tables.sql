CREATE TABLE HPL_SYSTEM_DYNAMICS.STSTEM_DYNAMICS.CR_ENV_SOURCE (
    TIME INT,
...
CREATE TABLE HPL_SYSTEM_DYNAMICS.STSTEM_DYNAMICS.CR_SAC_SOURCE (
    TIME INT,
    POSITIVE_FEEDBACK FLOAT,  -- A
    NEGATIVE_FEEDBACK FLOAT   -- B
);

CREATE TABLE HPL_SYSTEM_DYNAMICS.STSTEM_DYNAMICS.CR_TFE_SOURCE (
    TIME INT,
    CURRENT_TRL FLOAT,        -- T
    TARGET_TRL FLOAT,         -- P
...
CREATE TABLE HPL_SYSTEM_DYNAMICS.STSTEM_DYNAMICS.CR_SFY_SOURCE (
    TIME INT,
    RISK_SCORE FLOAT,         -- Rn
...
CREATE TABLE HPL_SYSTEM_DYNAMICS.STSTEM_DYNAMICS.CR_REG_SOURCE (
    TIME INT,
...
CREATE TABLE HPL_SYSTEM_DYNAMICS.STSTEM_DYNAMICS.CR_QMF_SOURCE (
    TIME INT,
    DISRUPTIVE_TECH_USED BOOLEAN, -- s
    TOTAL_DISRUPTIVE_TECH INT     -- d
);

CREATE TABLE HPL_SYSTEM_DYNAMICS.STSTEM_DYNAMICS.CR_ECV_SOURCE (
    TIME INT,
    REVENUE FLOAT,             -- Rev
    OPEX FLOAT,                -- OpEx
    CAPEX FLOAT,               -- CapEx
...
CREATE TABLE HPL_SYSTEM_DYNAMICS.STSTEM_DYNAMICS.CR_USB_SOURCE (
    TIME INT,
...
CREATE TABLE HPL_SYSTEM_DYNAMICS.STSTEM_DYNAMICS.CR_RLB_SOURCE (
    TIME INT,
    DURABILITY FLOAT,          -- d
...
CREATE TABLE HPL_SYSTEM_DYNAMICS.STSTEM_DYNAMICS.CR_INF_SOURCE (
    TIME INT,
...
CREATE TABLE HPL_SYSTEM_DYNAMICS.STSTEM_DYNAMICS.CR_SCL_SOURCE (
    TIME INT,
...
CREATE TABLE HPL_SYSTEM_DYNAMICS.STSTEM_DYNAMICS.HPL_SD_CRS (
    TIME INT,
    CR_ENV FLOAT,
    CR_SAC FLOAT,
    CR_TFE FLOAT,
